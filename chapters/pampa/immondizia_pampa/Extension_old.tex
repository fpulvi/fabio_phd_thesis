...
%\title{PaM-Car: A Parallel MapReduce-based Carpenter}
%\title{PaM-Car: A Parallel MapReduce-based Carpenter for High-dimensional Itemset Mining}
\title{PaMPa-HD: a Parallel MapReduce-based frequent Pattern miner for High-Dimensional data}
...
%
%\author{\IEEEauthorblockN{Daniele Apiletti\IEEEauthorrefmark{0},
%Elena Baralis\IEEEauthorrefmark{0},
%Tania Cerquitelli\IEEEauthorrefmark{0}, \\
%Paolo Garza\IEEEauthorrefmark{0}, and Fabio Pulvirenti\IEEEauthorrefmark{0}
%}
%\IEEEauthorblockA{\IEEEauthorrefmark{0}Dipartimento di Automatica e Informatica\\
%Politecnico di Torino\\
%Torino, Italy\\ Email: name.surname@polito.it}
%\and
%\IEEEauthorblockN{Pietro Michiardi\IEEEauthorrefmark{1}}
%\IEEEauthorblockA{\IEEEauthorrefmark{1}Eurecom Institute \\
%Sophia Antipolis, France\\ Email: pietro.michiardi@eurecom.fr}
%}


\author{\IEEEauthorblockN{Daniele Apiletti,
Elena Baralis,
Tania Cerquitelli, \\
Paolo Garza, and Fabio Pulvirenti
}
\IEEEauthorblockA{\IEEEauthorrefmark{0}Dipartimento di Automatica e Informatica\\
Politecnico di Torino\\
Torino, Italy\\ Email: name.surname@polito.it}
\and
\IEEEauthorblockN{Pietro Michiardi}
\IEEEauthorblockA{
%Networking in Security Department\\
Eurecom\\
Sophia Antipolis, France\\ Email: pietro.michiardi@eurecom.fr}
}
...
\input{centralizedcarpenter.tex}
...
local Carpenter \par until  expansion  threshold is reached \par  or memory  is not
enough
