...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  Esempio con molte opzioni
 \documentclass[11pt,twoside,oldstyle,autoretitolo,classica,greek,english]{toptesi}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\titolo{Frequent Itemset Mining Algorithms for Big Data}% per la laurea quinquennale e il dottorato
%\sottotitolo{Scalable Frequent Itemset mining}% per la laurea quinquennale e il dottorato
%
%%%%%%% Corso degli studi
%\corsodilaurea{Astronomia Applicata}% per la laurea
\corsodidottorato{Information and System Enginnering}% per il dottorato

%%%%%%% Per inserire la matricola rientrato sotto il nome di ogni candidato.
\renewcommand*\IDN{\\\quad matricola: }
%
\candidato{Fabio \textsc{Pulvirenti}}% per tutti i percorsi
...
%\coordinatore{Prof. Pietro Michiardi}% per il dottorato
%\relatore{Prof.\ Elena Baralis}% per la laurea e/o il dottorato
%\secondorelatore{Prof.\ Pietro Michiardi}% per la laurea magistrale
...
%%%%%%% Tutore
\tutore{Prof. Elena Baralis}
%\tutore{Prof. Pietro Michiardi}% per il dottorato
...
\esamedidottorato{Dicember 2016}% per il dottorato
%\annoaccademico{1615-1616}% solo con l'opzione classica
%\annoaccademico{2006-2007}% idem
\ciclodidottorato{XXIX}% solo per il dottorato
...
\iflanguage{english}{
	...
	\logosede{figures/logo.png}% or comma separated list of logos
}{}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
